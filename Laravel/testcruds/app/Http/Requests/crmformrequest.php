...
class crmformrequest extends FormRequest
{
    /**
   ...
   public function messages() : array
       {
            ...
            'amount.required' => 'The product price is required.',
            'amount.integer'  => 'The price must be a whole number (integer).',
            'amount.min'      => 'The price must be 0 or a positive number.',
