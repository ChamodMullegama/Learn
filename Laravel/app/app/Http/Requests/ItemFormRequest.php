...
class ItemFormRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            // Custom messages for the 'des' field
            'des.required' => 'The product des is required.',
            'des.string'   => 'The product des must be a string.',
            'des.max'      => 'The product des cannot be more than 255 characters.',
